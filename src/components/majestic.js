...
class Majestic extends Component{
    constructor() {
        super();
        this.state = {
            drawerOpened: false
    ...
    render(){
        return (
            <MuiThemeProvider>
                <div>
                <AppBar title='Welcome to Majestic Banquet'  onLeftIconButtonTouchTap={() => this._toggleDrawer()} style={{marginLeft: '-12%', width: '123.5%'}} />
...
export default connect(mapStateToProps, null) (Majestic);
